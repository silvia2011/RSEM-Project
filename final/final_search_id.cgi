...
=begin
Author: Silvia Chang
This script will search the user's entered geneID in MySQL database
and return the results in JSON format for processing
in the Javascript script via Ajax
=cut
